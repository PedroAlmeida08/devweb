...
const ProdutoPage = () => {
  ...
  const {data: produto,
    ...
    error: errorProduto} = useRecuperarProdutoPorId(+id!); // +id = converter id para number
                                                           // id! = ignorar o erro de id undefined

    if (carregandoProduto) return <p className="fw-bold">Carregando produto...</p>;
